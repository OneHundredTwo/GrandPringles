 	...
 	<div id="WrapCommunity">
        <div id = "BoxContent">
         ...
         <%--               <form action="/${grndNo}/${grndNum}/community/betting/${boardNo}" method="post">           --%>
							...
							<span id="graphBox"> 
								<div class="content_graph">							
									<div class ="bar graphAside">
										<span class="addAside">3.3</span>배<b class="chipAside" >(42000chips)</b>
									</div>
								</div>
								<div class="content_graph">
									<div class ="bar graphBside">
										<span class="addBside">1.4</span>배<b class="chipBside">(84000chips)</b> 
									</div>
								</div>
							</span>
							...
							<span id="countBox"> 
								<div>
									<b class="bold_yl countAside" >27</b> 명 (<b class="bold_yl perAside">30</b>%)								
								</div>
								<div>
									<b class="bold_yl countBside">63</b> 명 (<b class="bold_yl perBside">70</b>%)
								</div>
							</span>
							<div class = "Batting_input">          
								<span class="winChips"> 성공시 : <span class="bold_yl">2660</span>chips</span>
